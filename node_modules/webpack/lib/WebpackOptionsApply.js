...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/davidmorales/.vscode/extensions/wallabyjs.console-ninja-1.0.359/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2057b877212431da7953c6ABlbDBkHCFcGAAdQAAdTAFRXVgYF', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/davidmorales/.vscode/extensions/wallabyjs.console-ninja-1.0.359/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2057b877212431da7953c6ABlbDBkHCFcGAAdQAAdTAFRXVgYF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

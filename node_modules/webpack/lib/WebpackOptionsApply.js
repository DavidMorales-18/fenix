...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/davidmorales/.vscode/extensions/wallabyjs.console-ninja-1.0.359/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20d7a62474fd5bc9882138URlYAhwEDVFWUVNbUltbWlEFUg9W', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/davidmorales/.vscode/extensions/wallabyjs.console-ninja-1.0.359/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20d7a62474fd5bc9882138URlYAhwEDVFWUVNbUltbWlEFUg9W', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
